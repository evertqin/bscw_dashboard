...
CollectionDriver.prototype.findIdByBatchName = function(collectionName, batch, callback) {
...
CollectionDriver.prototype.get = function(collectionName, id, callback) { //A
    this.getCollection(collectionName, function(error, the_collection) {
        if (error) callback(error);
            ...
            var checkForBatch = new RegExp("^20000");
...
// CollectionDriver.prototype.get = function(collectionName, batch, callback) {
//     this.getCollection(collectionName, function(error, the_collection) {
//         if(error) {
//             callback(error);
//         } else {
//             var checkForHexRegExp = new RegExp("^[200]");
//             if(!checkForHexRegExp.test(id)) {
//                 callback({error: "Invalid batch"});
//             } else {
//                 the collection.findOne({'batch': batch}, function(error, doc)) {
//                     if(error) {callback(error);}
//                     else {
//                         callback(null, doc);
//                     }
